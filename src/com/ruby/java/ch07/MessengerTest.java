...
interface Messenger {
	...
	//인터페이스에서 메소드 body 구현하는 함수들은 default, static, private 만 가능
	public default void setLogin(boolean login) {//인터페이스를 상속받는 클래스들에서 공통적으로 사용. default 라고 명시
		log();
		if (login) {
...
//		log();
	...
	//public, abstract, default, static 만 가능 JDK9부터 private도 가능
	//
...
//		Messenger iphone1 = new IPhoneMessenger();
//		iphone1.log(false);
