...
public class UseConstructor_6_2 {
	...
	public static void main(String[] args) {
		...
		Student[] students = { new Student("홍길동", 21, subjects, new int[] { 85, 90, 78, 88, 92 }, -1),
				...
				/*
				 * 생성자를 사용하여 객체 생성 ("홍길동", 21, subjects, new int[]{85, 90, 78, 88, 92}, -1),
				 * ("김유신", 22, subjects, new int[]{75, 80, 85, 90, 95}, -1), ("계백", 23,
				 * subjects, new int[]{65, 70, 75, 80, 85}, -1), ("강감찬", 24, subjects, new
				 * int[]{95, 92, 88, 84, 91}, -1), "을지문덕", 25, subjects, new int[]{88, 76, 85,
				 * 79, 90}, -1)
				 */
		};
		// 학생 수를 정적 메소드 호출로 처리
